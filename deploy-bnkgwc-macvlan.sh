...
kubectl apply -f resources/bnkgatewayclass-macvlan.yaml

echo ""
echo "deploying pod alpine1 with nad macvlan-p0 and macvlan-p1 ..."
kubectl apply -f resources/alpine-macvlan.yaml
