...
kubectl apply -f resources/bnkgatewayclass-intel-host.yaml

echo ""
echo "deploying pod alpine1 with nad sriov-intel-p0 and sriov-intel-p1 ..."
kubectl apply -f resources/alpine-intel-sriov.yaml
...
echo ""
echo "check if pod alpine1 is running with intel sriov vf's attached ..."
